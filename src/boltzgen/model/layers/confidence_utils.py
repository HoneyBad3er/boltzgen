...
def compute_ptms(logits, x_preds, feats, multiplicity):
    ...
    design_to_target_ipsae = compute_ipsae_score(is_chain_design_token, is_target_token, expected_pae)
    target_to_design_ipsae = compute_ipsae_score(is_target_token, is_chain_design_token, expected_pae)
